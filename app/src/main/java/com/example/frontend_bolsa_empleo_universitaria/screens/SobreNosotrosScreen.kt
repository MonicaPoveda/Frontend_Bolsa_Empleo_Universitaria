        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Spacer(Modifier.height(14.dp))
                    Text(
                        text = "Plataforma académica diseñada para conectar estudiantes, egresados y empresas mediante ofertas laborales, gestión de postulaciones y seguimiento de oportunidades.",
            ...
            InfoSection(
                ...
                body = listOf("Monica Poveda", "Tania Beltrán", "Lizeth Moreno", "Fabián Meléndez", "Paula Ramírez").joinToString("\n")
            )
